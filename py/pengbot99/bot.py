...
#mp_mgr = miniprix.MiniPrixManager("miniprix", slot2mgr, mpsched, mirrorsc, mp_offset, mirror_offset)
mp_mgr = miniprix.MiniPrixManager("miniprix", slot2mgr, mpsched, None, mp_offset, 0)
